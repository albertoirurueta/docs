...
xref:backend/java/testing.adoc[Testing with JUnit 5 and Mockito] -- JUnit 5 runs Kotlin test classes with no
...
Backtick-escaped test names (xref:apps/android/kotlin/lexical-structure-and-style.adoc[Lexical Structure and
...
xref:backend/java/testing.adoc[Testing with JUnit 5 and Mockito] apply unchanged.
...
Testing a `suspend` function or a `Flow` (xref:apps/android/kotlin/coroutines-basics.adoc[Coroutines Basics],
xref:apps/android/kotlin/flows.adoc[Flows]) needs a coroutine to call it from, plus control over virtual time so
...
* xref:backend/java/testing.adoc[Testing with JUnit 5 and Mockito] -- the JUnit 5 foundation this page builds
  on.
* xref:apps/android/kotlin/coroutines-basics.adoc[Coroutines Basics] and
  xref:apps/android/kotlin/flows.adoc[Flows] -- what `runTest` is actually exercising.
* xref:apps/android/kotlin/lexical-structure-and-style.adoc[Lexical Structure and Style] -- backtick-escaped
