...
* xref:apps/android/kotlin/classes-and-objects.adoc[Classes and Objects] -- ordinary class declarations that
  `object`/`companion object` build on.
* xref:apps/android/kotlin/lambdas-and-higher-order-functions.adoc[Lambdas and Higher-Order Functions] -- when a
  lambda is enough and an object expression is not needed.
* xref:apps/android/kotlin/sealed-classes-and-enums.adoc[Sealed Classes and Enums] -- `object` as the no-data
