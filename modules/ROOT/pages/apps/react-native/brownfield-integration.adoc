...
The host app here is an ordinary native iOS app; for how such an app is structured -- the scene-based life
cycle, view controllers and hosting SwiftUI inside UIKit -- see
xref:apps/apple/app-structure-and-lifecycle.adoc[App Structure and Life Cycle] and
