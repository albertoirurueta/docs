...
link:++https://developer.apple.com/documentation/swiftdata/relationship(_:deleterule:minimummodelcount:maximummodelcount:originalname:inverse:hashmodifier:)++[+Apple Developer Documentation -- Relationship(_:deleteRule:minimumModelCount:maximumModelCount:originalName:inverse:hashModifier:)+]
and link:++https://developer.apple.com/documentation/swiftdata/index(_:)-74ia2++[+Apple Developer Documentation -- Index(_:)+].
...
See link:++https://developer.apple.com/documentation/swiftui/scene/modelcontainer(_:)++[+Apple Developer Documentation -- modelContainer(_:)+].
...
From xref:apps/apple/background-execution.adoc[Background Execution] on, this construction moves into a small
...
and link:++https://developer.apple.com/documentation/swiftdata/unique(_:)++[+Apple Developer Documentation -- Unique(_:)+].
...
* link:++https://developer.apple.com/documentation/swiftdata/unique(_:)++[+Apple Developer Documentation -- Unique(_:)+]
* link:++https://developer.apple.com/documentation/swiftdata/index(_:)-74ia2++[+Apple Developer Documentation -- Index(_:)+]
...
* link:++https://developer.apple.com/documentation/swiftui/scene/modelcontainer(_:)++[+Apple Developer Documentation -- modelContainer(_:)+]
