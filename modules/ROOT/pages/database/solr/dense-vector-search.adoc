...
* xref:database/vector-rag/ann-indexes.adoc[] and xref:database/vector-rag/quantization-and-compression.adoc[]
  -- the vendor-neutral HNSW and compression theory behind Solr's `DenseVectorField` index.
