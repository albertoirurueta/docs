...
functions are covered separately in xref:database/sql/aggregate-window-functions.adoc[]. Functions that operate on JSON
or XML values are covered separately in xref:database/sql/json-xml-functions.adoc[]. This page is scoped to the
