...
:page-aliases: backend/java/packages-and-modules.adoc
...
xref:programming-languages/java/build-and-tooling.adoc[Build and Tooling].
...
* xref:programming-languages/java/build-and-tooling.adoc[Build and Tooling] -- `javac`, `jar`, `jdeps`, `jlink`, and
  the Maven/Gradle layout that produces the class tree.
* xref:programming-languages/java/classes-and-objects.adoc[Classes and Objects] -- applying `public` / `protected` /
  `private` to individual members.
* xref:programming-languages/java/interfaces.adoc[Interfaces] -- the service interfaces behind `uses` and
  `provides ... with`.
* xref:programming-languages/java/annotations-and-reflection.adoc[Annotations and Reflection] -- why `opens` exists
