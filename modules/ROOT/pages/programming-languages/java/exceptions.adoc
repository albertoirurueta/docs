...
:page-aliases: backend/java/exceptions.adoc
...
xref:programming-languages/java/io-and-files.adoc[I/O and Files].
...
* xref:programming-languages/java/io-and-files.adoc[I/O and Files] -- `IOException`, `UncheckedIOException`, and why
  streams belong in try-with-resources.
* xref:programming-languages/java/optional.adoc[Optional] -- returning "no value" instead of throwing when absence is
  an ordinary outcome.
* xref:programming-languages/java/records-and-sealed-classes.adoc[Records and Sealed Classes] -- modelling a
  recoverable success/failure result as data.
* xref:programming-languages/java/annotations-and-reflection.adoc[Annotations and Reflection] --
