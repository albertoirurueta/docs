...
:page-aliases: backend/java/primitive-types-and-variables.adoc
...
xref:programming-languages/java/numbers-and-math.adoc[Numbers and Math]. Fields and array elements are automatically
...
3.10]. `String` literals and text blocks are on xref:programming-languages/java/strings-and-text.adoc[Strings and Text].
...
* xref:programming-languages/java/operators-and-expressions.adoc[Operators and Expressions] -- what you do with these
  values, including numeric promotion.
* xref:programming-languages/java/numbers-and-math.adoc[Numbers and Math] -- wrapper classes, `BigInteger`,
  `BigDecimal`, and `Math`.
* xref:programming-languages/java/strings-and-text.adoc[Strings and Text] -- `String` literals and text blocks.
* xref:programming-languages/java/lexical-structure-and-style.adoc[Lexical Structure and Style] -- where literals and
