...
:page-aliases: backend/java/numbers-and-math.adoc

include::partial$java-disclaimer.adoc[]

Java has two families of numbers: the *primitives* (`int`, `long`, `double`, ...) covered on
xref:programming-languages/java/primitive-types-and-variables.adoc[Primitive Types and Variables], and the *object*
...
* xref:programming-languages/java/primitive-types-and-variables.adoc[Primitive Types and Variables] -- the `int`,
  `long` and `double` primitives these types wrap, plus widening and narrowing.
* xref:programming-languages/java/operators-and-expressions.adoc[Operators and Expressions] -- integer division,
  `%`, and numeric promotion inside expressions.
* xref:programming-languages/java/methods-and-parameters.adoc[Methods and Parameters] -- the `Math` and `Objects`
  helpers from the method author's perspective.
* xref:programming-languages/java/strings-and-text.adoc[Strings and Text] -- `String.format`, text blocks, and
