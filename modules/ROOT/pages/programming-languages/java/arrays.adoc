...
:page-aliases: backend/java/arrays.adoc
...
xref:programming-languages/java/collections-framework.adoc[the Collections Framework]. This page follows the
...
xref:programming-languages/java/control-flow.adoc[enhanced `for`] when you only read each element.
...
and why mixing arrays with generics is discouraged -- see xref:programming-languages/java/generics.adoc[Generics].
...
* xref:programming-languages/java/collections-framework.adoc[Collections Framework] -- `List`, `Set`, `Map`, and when
  to prefer them over raw arrays.
* xref:programming-languages/java/generics.adoc[Generics] -- type erasure, and why arrays and generics mix poorly.
* xref:programming-languages/java/control-flow.adoc[Control Flow] -- the indexed and enhanced `for` in detail.
* xref:programming-languages/java/streams-and-collectors.adoc[Streams and Collectors] -- `Arrays.stream` and bulk
  data processing.
