= Classes and Objects
:description: Declaring Java classes: fields, methods, constructors, this, constructor chaining with this(...), the default constructor, heap allocation and reference semantics, null and NullPointerException, garbage collection, static members and initializer blocks, static final constants, access modifiers, and JVM memory -- the stack and metaspace alongside the heap.
:keywords: Java, class, object, field, method, constructor, this, constructor chaining, default constructor, heap, reference semantics, null, NullPointerException, helpful NullPointerException, garbage collection, static, static initializer, instance initializer, static final, constant, access modifier, encapsulation, accessor, stack, metaspace, JVM memory
:page-aliases: backend/java/classes-and-objects.adoc
...
covered on xref:programming-languages/java/inheritance-and-polymorphism.adoc[Inheritance and Polymorphism].
...
Prefer xref:programming-languages/java/optional.adoc[`Optional`] over `null` for "might be absent" return values, and
...
covered on xref:programming-languages/java/io-and-files.adoc[I/O and Files].
...
(xref:programming-languages/java/records-and-sealed-classes.adoc[Records and Sealed Classes]). The full rules,
including `protected` access across packages and the module system, are on
xref:programming-languages/java/packages-and-modules.adoc[Packages and Modules].
...
* xref:programming-languages/java/inheritance-and-polymorphism.adoc[Inheritance and Polymorphism] -- `extends`,
  `super(...)`, and overriding built on these class basics.
* xref:programming-languages/java/records-and-sealed-classes.adoc[Records and Sealed Classes] -- the concise way to
  write a transparent immutable data class.
* xref:programming-languages/java/methods-and-parameters.adoc[Methods and Parameters] -- parameter passing,
  overloading, and `this` in more depth.
* xref:programming-languages/java/packages-and-modules.adoc[Packages and Modules] -- the full access-control and
  visibility rules.
