...
:page-aliases: backend/java/testing.adoc
...
xref:programming-languages/java/build-and-tooling.adoc[Build and Tooling]. Writing tests overall is covered in the
User Guide under
...
* xref:programming-languages/java/build-and-tooling.adoc[Build and Tooling] -- wiring `junit-jupiter` into Maven or
  Gradle and running the suite from the build.
* xref:programming-languages/java/exceptions.adoc[Exceptions] -- `assertThrows` and testing the failure paths.
* xref:programming-languages/java/high-level-concurrency.adoc[High-Level Concurrency] -- `assertTimeout` and testing
  code that runs asynchronously.
* xref:programming-languages/java/annotations-and-reflection.adoc[Annotations and Reflection] -- how `@Test` and
