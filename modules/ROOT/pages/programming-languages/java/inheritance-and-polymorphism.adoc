...
:page-aliases: backend/java/inheritance-and-polymorphism.adoc
...
*Overloading* (covered on xref:programming-languages/java/methods-and-parameters.adoc[Methods and Parameters]) is
...
xref:programming-languages/java/pattern-matching.adoc[Pattern Matching]. Prefer polymorphic method calls over
...
xref:programming-languages/java/records-and-sealed-classes.adoc[Records and Sealed Classes].
...
* xref:programming-languages/java/classes-and-objects.adoc[Classes and Objects] -- constructors, fields, and access
  control that inheritance builds on.
* xref:programming-languages/java/interfaces.adoc[Interfaces] -- inheritance of *type* without implementation, and
  `default` methods.
* xref:programming-languages/java/records-and-sealed-classes.adoc[Records and Sealed Classes] -- transparent carriers
  and restricted hierarchies.
* xref:programming-languages/java/methods-and-parameters.adoc[Methods and Parameters] -- overloading and the `Objects`
