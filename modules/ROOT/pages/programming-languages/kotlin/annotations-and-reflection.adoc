...
:page-aliases: apps/android/kotlin/annotations-and-reflection.adoc
...
xref:programming-languages/kotlin/functions.adoc[Functions]), Java callers would otherwise not see a plain static method
...
* xref:programming-languages/kotlin/functions.adoc[Functions] -- default arguments, the feature `@JvmOverloads` exists
  to bridge to Java.
* xref:programming-languages/kotlin/testing.adoc[Testing] -- how `@Test`/`@ExtendWith` are themselves discovered via
  runtime-retained annotations and reflection.
* xref:programming-languages/kotlin/kotlin-and-the-jvm.adoc[Kotlin and the JVM] -- the Java-interop annotations in the
