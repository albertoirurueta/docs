...
:page-aliases: apps/android/kotlin/collections-and-sequences.adoc
...
(see xref:programming-languages/kotlin/extension-functions-and-scope-functions.adoc[Extension Functions and Scope
...
* xref:programming-languages/kotlin/generics-and-variance.adoc[Generics and Variance] -- why `List<out T>` is covariant
...
* xref:programming-languages/kotlin/flows.adoc[Flows] -- `Sequence`'s asynchronous counterpart for values arriving over
  time.
