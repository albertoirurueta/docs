...
See xref:programming-languages/java/build-and-tooling.adoc#_publishing_to_maven_central[Publishing to Maven
Central] for the full account setup, user token, GPG key, and GitHub Actions release workflow -- none of that is
repeated here since nothing about it differs for Kotlin.

NOTE: A Kotlin Multiplatform library publishes multiple platform-specific artifacts (JVM, JS, Native, ...) under
