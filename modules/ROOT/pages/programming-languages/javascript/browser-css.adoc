...
:page-aliases: web/javascript/browser-css.adoc

include::partial$javascript-disclaimer.adoc[]

Beyond querying and mutating the document tree (see xref:programming-languages/javascript/browser-dom-basics.adoc[The DOM]),
...
xref:programming-languages/javascript/browser-geometry-scrolling.adoc[Document Geometry & Scrolling]) over parsing computed style
values.
