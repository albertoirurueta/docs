...
:page-aliases: web/javascript/browser-canvas-webgl.adoc
...
declarative, DOM-based shapes of SVG (see xref:programming-languages/javascript/browser-dom-basics.adoc[The DOM]). It has two very
...
property is a xref:programming-languages/javascript/arrays.adoc[`Uint8ClampedArray`] -- four consecutive bytes per pixel, laid out
...
xref:programming-languages/javascript/browser-animations.adoc[Animations via JavaScript] for the render-loop pattern itself
...
For the Android counterpart to this page's 2D and 3D drawing APIs,
see xref:apps/android/graphics-canvas-and-opengl-es.adoc[Graphics: Canvas, OpenGL ES and GLTextureView].
