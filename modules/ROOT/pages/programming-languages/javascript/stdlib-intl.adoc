...
:description: Reference for JavaScript's Intl namespace: locale-aware number formatting, date/time formatting, string collation, and plural rules via Intl.NumberFormat, Intl.DateTimeFormat, Intl.Collator, and Intl.PluralRules.
:keywords: JavaScript, Intl, internationalization, i18n, Intl.NumberFormat, Intl.DateTimeFormat, Intl.Collator, Intl.PluralRules, locale, ECMA-402
:page-aliases: web/javascript/stdlib-intl.adoc
...
xref:programming-languages/javascript/stdlib-dates-errors-json.adoc[Standard Library: Dates, Errors & JSON] for `Date` construction
