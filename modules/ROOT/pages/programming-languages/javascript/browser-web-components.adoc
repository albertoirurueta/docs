...
:page-aliases: web/javascript/browser-web-components.adoc
...
`#render` (a private class field method -- see xref:programming-languages/javascript/classes.adoc[Classes]) is called from both
...
xref:programming-languages/javascript/browser-dom-basics.adoc[Web Programming Basics] -- a custom element instance is still an
...
the same rules covered on xref:programming-languages/javascript/browser-events.adoc[Events].
