...
:page-aliases: web/javascript/stdlib-metaprogramming.adoc
...
(xref:programming-languages/javascript/classes.adoc[Classes]) covers the vast majority of "control how a property behaves" needs
