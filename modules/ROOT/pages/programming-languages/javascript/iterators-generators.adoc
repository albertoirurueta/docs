...
:page-aliases: web/javascript/iterators-generators.adoc
...
`{ value, done }` shape described in this page. See xref:programming-languages/javascript/async-javascript.adoc[Asynchronous
