...
:page-aliases: web/javascript/stdlib-utilities.adoc
...
xref:programming-languages/javascript/async-javascript.adoc[Asynchronous JavaScript] for how the microtask queue relates to
