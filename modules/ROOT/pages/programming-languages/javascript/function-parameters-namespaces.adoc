...
:page-aliases: web/javascript/function-parameters-namespaces.adoc
...
or into individual elements inside an array/object literal -- see xref:programming-languages/javascript/arrays.adoc[Arrays &
Typed Arrays] and xref:programming-languages/javascript/objects-destructuring.adoc[Objects & Destructuring].

== Destructured Parameters

Because parameter binding works like an assignment, the same destructuring patterns covered in
xref:programming-languages/javascript/objects-destructuring.adoc[Objects & Destructuring] can be applied directly in a
...
[NOTE]
====
See also xref:programming-languages/javascript/legacy-features.adoc[Legacy Features to Avoid]. Before rest parameters were
...
[NOTE]
====
This pattern is a pre-ES6 workaround. Prefer ES modules, covered in xref:programming-languages/javascript/modules.adoc[Modules],
...
xref:programming-languages/javascript/modules.adoc[Modules] for the modern replacement.
