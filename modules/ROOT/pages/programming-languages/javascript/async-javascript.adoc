...
:description: Explains JavaScript's three layers of asynchronous programming -- callbacks, Promises (states, chaining, Promise.all/race/any), and async/await -- plus async iteration and the microtask/macrotask event loop.
:keywords: asynchronous JavaScript, Promises, async/await, callbacks, Promise.all, async iterators, async generators, event loop, microtask queue, for await of
:page-aliases: web/javascript/async-javascript.adoc
...
xref:programming-languages/javascript/iterators-generators.adoc[iterator protocol] to streams of asynchronous values.
...
Browser event handling is callback-based too (see xref:programming-languages/javascript/browser-events.adoc[Events] for the full
picture):
...
response. See xref:programming-languages/javascript/browser-networking.adoc[Networking] for the full `fetch()` API surface (request
...
extend the xref:programming-languages/javascript/iterators-generators.adoc[synchronous iterator protocol] to this case.
...
Conceptually: an async generator is a regular generator function (xref:programming-languages/javascript/iterators-generators.adoc[
