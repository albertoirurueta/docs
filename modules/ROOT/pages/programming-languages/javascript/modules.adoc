...
:page-aliases: web/javascript/modules.adoc
...
substitute (superseded, see xref:programming-languages/javascript/legacy-features.adoc[Legacy Features to Avoid]), Node's
...
xref:programming-languages/javascript/function-parameters-namespaces.adoc[Function Parameters & Namespaces]. Where that pattern
