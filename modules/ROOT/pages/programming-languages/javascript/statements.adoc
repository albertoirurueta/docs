= Statements
:description: Reference for JavaScript's control-flow statements: if/else/switch conditionals, while/do-while/for/for-of/for-in loops, and the break/continue jump statements.
:keywords: JavaScript, statements, if, else if, switch, while, do while, for loop, for of, for in, break, continue, control flow, labeled statements
:page-aliases: web/javascript/statements.adoc
...
xref:programming-languages/javascript/functions-expressions-operators.adoc[Functions, Expressions & Operators]) produce values,
...
xref:programming-languages/javascript/iterators-generators.adoc[Iterators & Generators] for what makes an object iterable):
...
xref:programming-languages/javascript/objects-destructuring.adoc[Objects, Properties & Destructuring]):
...
xref:programming-languages/javascript/async-javascript.adoc[Asynchronous JavaScript] for how it relates to promises and async
generators.
...
(see xref:programming-languages/javascript/lexical-structure.adoc[Lexical Structure]) would otherwise insert a semicolon right
