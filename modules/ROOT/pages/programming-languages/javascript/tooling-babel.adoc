...
:description: An explanation of how Babel transpiles modern JavaScript syntax for older environments using @babel/preset-env and browserslist targets, with a worked ES2022-to-ES5 example, how source maps keep transpiled code debuggable, and why transpilation is a distinct problem from polyfilling.
:keywords: JavaScript, Babel, transpilation, @babel/preset-env, browserslist, @babel/preset-react, JSX, source maps, polyfill, core-js, useBuiltIns, ECMAScript, babel.config.json
:page-aliases: web/javascript/tooling-babel.adoc
...
xref:programming-languages/javascript/tooling-bundling-npm-publishing.adoc[Bundling & npm Publishing]) production build at all: the
...
in a single pass. See xref:programming-languages/javascript/tooling-bundling-npm-publishing.adoc[Bundling & npm Publishing] for how
