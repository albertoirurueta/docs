...
* xref:programming-languages/cpp/namespaces-modules-and-the-preprocessor.adoc[{cpp}: Namespaces, Modules, and
  the Preprocessor] -- {cpp} keeps the same preprocessor but moves most of its jobs into the language.
