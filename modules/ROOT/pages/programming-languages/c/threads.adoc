...
* xref:programming-languages/c/advanced-control-flow.adoc[Advanced Control Flow] -- why signals and threads
  interact badly.
* xref:programming-languages/cpp/threads-and-synchronization.adoc[{cpp}: Threads and Synchronization] -- {cpp}
  adds RAII lock guards, `std::jthread` and `stop_token` cancellation.
