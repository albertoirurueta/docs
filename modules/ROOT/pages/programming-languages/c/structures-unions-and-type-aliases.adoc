...
* xref:programming-languages/c/type-generic-programming.adoc[Type-Generic Programming] -- `_Generic` over
  struct types.
* xref:programming-languages/cpp/classes-and-objects.adoc[{cpp}: Classes and Objects] -- a {cpp} `struct` is a
  class with public defaults -- constructors, destructors and invariants on top of this layout.
