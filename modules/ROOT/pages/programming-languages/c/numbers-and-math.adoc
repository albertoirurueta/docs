...
* *The quality is unspecified.* The standard requires only that `RAND_MAX` be at least 32767; it says nothing
  about the period or the statistical quality, and historically some implementations were dreadful in the low
  bits.
...
* xref:programming-languages/cpp/numbers-and-math.adoc[{cpp}: Numbers and Math] -- the same math core, plus
