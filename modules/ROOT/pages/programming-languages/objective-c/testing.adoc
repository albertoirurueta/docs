...
* xref:apps/apple/ui-tests-test-plans-and-coverage.adoc[UI Tests, Test Plans, Performance Tests and Coverage] --
  XCTest UI automation, performance tests, test plans and coverage in an app project, and
  xref:apps/apple/testing-with-swift-testing.adoc[Unit Testing with Swift Testing] for mixing XCTest with Swift
  Testing.
