...
stateDiagram-v2
    ...
    Pooled --> Deallocating: pool drains,<br/>count reaches 0
    Initialized --> Deallocating: -release,<br/>count reaches 0

    Deallocating --> [*]: -dealloc runs<br/>(release ivars, then [super dealloc])
    ...
    Initialized --> Dangling: -release sent<br/>once too often
