...
:page-aliases: web/typescript/decorators-and-metadata.adoc
...
* xref:programming-languages/typescript/classes.adoc[] -- the class members that decorators attach to.
...
* xref:programming-languages/typescript/tsconfig-and-compiler-options.adoc[] -- `experimentalDecorators`, `emitDecoratorMetadata` and related flags.
* xref:programming-languages/typescript/javascript-interop.adoc[] -- how decorated code is emitted and consumed from plain JavaScript.
