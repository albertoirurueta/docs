...
:page-aliases: web/typescript/javascript-interop.adoc
...
xref:programming-languages/typescript/declaration-files.adoc[declaration file]. What it cannot do comfortably is the
...
xref:programming-languages/typescript/tsconfig-and-compiler-options.adoc[tsconfig and Compiler Options] for what each
...
* xref:programming-languages/typescript/worked-example.adoc[] -- a project built with these settings from the start.
* xref:programming-languages/typescript/declaration-files.adoc[] -- authoring and consuming `.d.ts` files.
* xref:programming-languages/typescript/tsconfig-and-compiler-options.adoc[] -- every flag named above.
* xref:programming-languages/typescript/enums-and-literal-alternatives.adoc[] -- alternatives to `enum`.
* xref:programming-languages/javascript/index.adoc[] -- the plain-JavaScript track these pages build on.
