...
:page-aliases: web/typescript/everyday-types.adoc
...
https://www.typescriptlang.org/docs/handbook/2/everyday-types.html[Everyday Types] handbook chapter, and pairs with the JavaScript-side xref:programming-languages/javascript/types.adoc[] page for how the underlying values behave at runtime.
...
Arrays, `readonly` arrays, tuples, labelled elements, and variadic tuple types get the full treatment on xref:programming-languages/typescript/arrays-and-tuples.adoc[].
...
Interfaces versus `type` aliases, index signatures, and excess-property checks are covered on xref:programming-languages/typescript/objects-and-interfaces.adoc[].
