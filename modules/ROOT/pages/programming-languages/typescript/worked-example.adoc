...
:page-aliases: web/typescript/worked-example.adoc
...
xref:programming-languages/typescript/tsconfig-and-compiler-options.adoc[tsconfig and Compiler Options] and the
...
See xref:programming-languages/typescript/javascript-interop.adoc[JavaScript Interop] and the handbook's
...
xref:programming-languages/typescript/unions-and-narrowing.adoc[Unions and Narrowing] and
xref:programming-languages/typescript/utility-types.adoc[Utility Types], plus the handbook's
...
xref:programming-languages/typescript/type-design-and-best-practices.adoc[Type Design and Best Practices] and the
...
xref:programming-languages/typescript/type-assertions-and-modifiers.adoc[Type Assertions and Modifiers] and the
