...
:page-aliases: web/typescript/classes.adoc

include::partial$typescript-disclaimer.adoc[]

TypeScript classes are ES2015 classes (see xref:programming-languages/javascript/classes.adoc[]) plus a type layer: member type
...
`const` type parameters, inference -- is on xref:programming-languages/typescript/generics.adoc[].
...
xref:programming-languages/typescript/decorators-and-metadata.adoc[].

== See also

* xref:programming-languages/javascript/classes.adoc[] -- the ES2015 class runtime that TypeScript classes compile to.
* xref:programming-languages/typescript/generics.adoc[] -- type parameters, constraints, and the constructor types mixins depend on.
* xref:programming-languages/typescript/objects-and-interfaces.adoc[] -- interfaces, `implements` targets, and structural typing.
* xref:programming-languages/typescript/decorators-and-metadata.adoc[] -- the standard (TC39) decorator syntax for classes and members.
