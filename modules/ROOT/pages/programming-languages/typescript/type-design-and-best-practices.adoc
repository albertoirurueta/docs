...
:page-aliases: web/typescript/type-design-and-best-practices.adoc
...
See xref:programming-languages/typescript/unions-and-narrowing.adoc[] for the discriminated-union mechanics. Note that
...
the domain type are in xref:programming-languages/typescript/utility-types.adoc[].
...
* xref:programming-languages/typescript/objects-and-interfaces.adoc[] -- `interface` vs `type`, `readonly`, and excess-property checks.
* xref:programming-languages/typescript/unions-and-narrowing.adoc[] -- discriminated unions and the narrowing constructs these designs rely on.
* xref:programming-languages/typescript/utility-types.adoc[] -- `Partial`, `Required`, `Readonly`, `NonNullable` for boundary-vs-domain types.
* xref:programming-languages/typescript/type-manipulation.adoc[] -- mapped, conditional and template-literal types behind branding and XOR helpers.
* xref:programming-languages/typescript/worked-example.adoc[] -- these rules applied end to end in one small codebase.
