...
:page-aliases: web/typescript/tsconfig-and-compiler-options.adoc
...
* `module` picks the output module format; `moduleResolution` picks how bare specifiers are looked up.
  ...
  Vite / esbuild / webpack. Depth in xref:programming-languages/typescript/modules.adoc[].
...
* xref:programming-languages/typescript/modules.adoc[] -- `module`, `moduleResolution`, and import rules in depth.
* xref:programming-languages/typescript/project-references-and-build.adoc[] -- `composite`, `tsc --build`, and the
