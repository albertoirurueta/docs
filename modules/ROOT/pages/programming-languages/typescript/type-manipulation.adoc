...
:page-aliases: web/typescript/type-manipulation.adoc
...
the map; this page tours each operator with a runnable example. See xref:programming-languages/typescript/generics.adoc[] for
the type parameters these operators run on, and xref:programming-languages/typescript/utility-types.adoc[] for the standard
...
* xref:programming-languages/typescript/generics.adoc[Generics] -- type parameters and constraints, where `infer` lives.
* xref:programming-languages/typescript/utility-types.adoc[Utility Types] -- `Partial`, `Pick`, `Exclude`, `ReturnType`, and
  the rest, each a thin wrapper over the operators here.
* xref:programming-languages/typescript/objects-and-interfaces.adoc[Objects and Interfaces] -- the object types these
  operators transform.
* xref:programming-languages/typescript/the-type-system.adoc[The Type System] -- unions, intersections, and assignability,
