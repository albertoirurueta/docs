...
:page-aliases: web/typescript/objects-and-interfaces.adoc
...
xref:programming-languages/typescript/type-manipulation.adoc[] and xref:programming-languages/typescript/utility-types.adoc[]. When you do keep a
...
augmentations as part of a package, see xref:programming-languages/typescript/declaration-files.adoc[].
...
`readonly` classes and parameter properties are covered in xref:programming-languages/typescript/classes.adoc[].
