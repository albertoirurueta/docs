...
:page-aliases: web/typescript/generics.adoc
...
See xref:programming-languages/typescript/functions.adoc[Functions] for call signatures and overloads, and
xref:programming-languages/typescript/classes.adoc[Classes] for generic classes in depth.
...
types in xref:programming-languages/typescript/utility-types.adoc[Utility Types] are all generic -- each is a small
...
utility types reference, and xref:programming-languages/typescript/utility-types.adoc[Utility Types].
...
* xref:programming-languages/typescript/type-manipulation.adoc[Type Manipulation] -- `keyof`, indexed access, conditional and
  mapped types that generics are built from.
* xref:programming-languages/typescript/utility-types.adoc[Utility Types] -- the standard library of generic type-level
  functions.
* xref:programming-languages/typescript/functions.adoc[Functions] -- generic call signatures, overloads, and `this` typing.
* xref:programming-languages/typescript/classes.adoc[Classes] -- generic classes and methods.
* xref:programming-languages/typescript/async-and-iterators.adoc[Async and Iterators] -- `Promise<T>`, `Awaited<T>`, and
