...
:page-aliases: web/python/iterators-generators-comprehensions.adoc
...
* xref:programming-languages/python/collections.adoc[] -- the list, set, and dict types that comprehensions build, and the
  comprehension syntax these iterators and generators sit underneath.
* xref:programming-languages/python/functions.adoc[] -- function definitions and calls, including the `yield` keyword that
