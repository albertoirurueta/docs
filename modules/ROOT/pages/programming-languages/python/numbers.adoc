...
:page-aliases: web/python/numbers.adoc
...
`math` (plus `random` and `statistics`) is covered in depth in xref:programming-languages/python/standard-library-tour.adoc[].

== See Also

* xref:programming-languages/python/variables-and-dynamic-typing.adoc[] -- how names bind to numeric values and how Python
  tracks their types at runtime.
* xref:programming-languages/python/standard-library-tour.adoc[] -- the `math`, `random`, and `statistics` modules in depth.
