...
:page-aliases: web/python/control-flow.adoc
...
* xref:programming-languages/python/functions.adoc[] -- defining the functions called from inside these branches and loops.
* xref:programming-languages/python/exceptions.adoc[] -- handling errors that `if` checks and `match` guards can't rule out ahead of time.
