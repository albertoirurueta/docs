...
:page-aliases: web/python/collections.adoc
...
xref:programming-languages/python/iterators-generators-comprehensions.adoc[] for the full comprehension syntax including `if`
clauses and nesting:
...
* xref:programming-languages/python/iterators-generators-comprehensions.adoc[] -- comprehension syntax in full, plus generators
  and iterator protocols built on top of these collections.
* xref:programming-languages/python/strings-and-text.adoc[] -- strings as an immutable sequence type, and how they interact with
