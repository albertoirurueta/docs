...
:page-aliases: web/python/managed-attributes.adoc
...
* xref:programming-languages/python/classes-and-objects.adoc[] -- classes, instances, and `__dict__`, the foundation
  `@property` and descriptors build on.
* xref:programming-languages/python/decorators-and-metaclasses.adoc[] -- `@property` is itself a decorator; metaclasses are
