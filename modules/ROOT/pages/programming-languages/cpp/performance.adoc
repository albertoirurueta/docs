...
:keywords: C++, zero-overhead principle, profiling, benchmarking, move semantics, reserve, constexpr, inlining, undefined behavior, sanitizers, ASan, UBSan

include::partial$cpp-disclaimer.adoc[]

== The Zero-Overhead Principle

Stroustrup's founding design rule for C++: a feature you don't use costs you nothing, and a feature you do use
