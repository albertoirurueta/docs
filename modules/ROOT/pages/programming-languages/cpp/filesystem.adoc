...
:keywords: {cpp}, std::filesystem, path, directory_iterator, recursive_directory_iterator, error_code, file properties

include::partial$cpp-disclaimer.adoc[]

{cpp}17's `<filesystem>` (modeled on Boost.Filesystem) provides a portable API for paths and file operations that
