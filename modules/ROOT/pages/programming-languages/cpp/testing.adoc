...
:keywords: C++, GoogleTest, GoogleMock, Catch2, Boost.Test, CTest, static_assert testing

include::partial$cpp-disclaimer.adoc[]

C++ has no single built-in test framework the way JUnit/pytest anchor Java/Python -- **GoogleTest** and
