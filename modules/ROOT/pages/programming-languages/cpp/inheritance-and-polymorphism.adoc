...
:keywords: C++, inheritance, virtual functions, override, final, abstract class, virtual destructor, object slicing, dynamic_cast, RTTI, static_cast, reinterpret_cast, const_cast
