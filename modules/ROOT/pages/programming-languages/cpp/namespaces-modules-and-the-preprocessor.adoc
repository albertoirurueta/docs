...
* xref:programming-languages/c/preprocessor-and-macros.adoc[C: Preprocessor and Macros] -- the same
  preprocessor, carrying far more of the load in the absence of namespaces, templates and modules.
