...
:keywords: C++, namespaces, inline namespace, using declaration, ADL, preprocessor, macros, VA_OPT, module partitions, feature-test macros
...
**inline namespace** (C++11) makes its contents visible as if they were in the enclosing namespace, used mainly
