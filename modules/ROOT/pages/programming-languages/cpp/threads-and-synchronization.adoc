...
:keywords: C++, std::thread, std::jthread, stop_token, mutex, lock_guard, scoped_lock, unique_lock, shared_mutex, condition_variable, latch, barrier, counting_semaphore, thread_local
