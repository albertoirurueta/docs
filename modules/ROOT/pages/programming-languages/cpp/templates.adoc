...
:keywords: C++, templates, template argument deduction, CTAD, deduction guides, non-type template parameters, variadic templates, fold expressions, template specialization, two-phase lookup
...
**Class Template Argument Deduction** (C++17) lets a class template's constructor arguments determine its
...
A template parameter can be a *value* (an integer, a pointer, an enum, and since C++20 a floating-point value
