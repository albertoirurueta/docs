...
:keywords: C++, function overloading, default arguments, defaulted functions, deleted functions, lambda expressions, captures, std::function, std::invoke, noexcept, nodiscard
