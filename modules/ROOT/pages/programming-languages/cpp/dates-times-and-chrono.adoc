...
:keywords: C++, chrono, duration, time_point, steady_clock, system_clock, year_month_day, time zones, chrono formatting
...
C++20 added a full calendar library on top of `chrono`, replacing manual day/month/year arithmetic and the
...
`<chrono>`'s time-zone database (C++20) converts between UTC and a named IANA zone -- no more manually applying
UTC offsets:
