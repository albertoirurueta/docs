...
:keywords: C++, fundamental types, int, fixed-width integers, cstdint, char8_t, auto, decltype, type alias, using, implicit conversion, limits, sizeof, alignof
...
C++ has six distinct character types, each with its own encoding role:
