...
* xref:programming-languages/c/error-handling-and-program-failure.adoc[C: Error Handling and Program Failure] --
  return codes, `errno` and `goto` cleanup -- how the same problems are handled without exceptions or
  destructors.
