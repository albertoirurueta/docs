...
https://docs.spring.io/spring-data/jpa/reference/[Spring Data JPA -- Reference Documentation] for the full
mapping model, and the underlying Jakarta Persistence specification for annotation details.
...
See https://docs.spring.io/spring-data/jpa/reference/[Spring Data JPA -- Reference Documentation] and the
Jakarta Persistence specification's inheritance-mapping chapter for the full trade-off discussion, including how
each strategy interacts with `@GeneratedValue` identifier generation.
