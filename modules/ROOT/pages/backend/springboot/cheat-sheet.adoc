...
:description: A single-page, printable Spring Boot 4.1.x / Spring Framework 6.2.x quick reference -- auto-configuration, beans and DI, configuration and profiles, Spring Data across SQL/MongoDB/Couchbase/Neo4j, caching, REST and gRPC, web UI frameworks, Kafka messaging, scheduling and ShedLock, logging, observability, reactive programming, Lombok/MapStruct, testing, JMeter, API-first development, build/quality plugins, and an architecture glossary -- with links to every detailed page in this section.
