...
directly); see xref:database/redis/use-cases-and-patterns.adoc[Redis: Use Cases and Patterns] for the underlying distributed locking algorithm.
...
For the Quarkus equivalent -- `@Scheduled` with Quartz for clustered, persistent schedules instead of ShedLock's
distributed lock -- see xref:backend/quarkus/scheduling-and-mail.adoc[Scheduling and Mail].
