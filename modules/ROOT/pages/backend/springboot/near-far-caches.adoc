...
notification handling; see xref:database/redis/streams-and-pub-sub.adoc[Redis: Streams and Pub/Sub] for deeper coverage of the messaging mechanics and xref:database/redis/clients-and-client-side-caching.adoc[Redis: Clients and Client-Side Caching] for how clients consume invalidation events.
