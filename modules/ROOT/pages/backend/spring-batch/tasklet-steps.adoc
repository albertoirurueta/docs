...
Since 6.0, a long-running tasklet can also honour an external stop request by implementing `StoppableStep` --
see xref:backend/spring-batch/stopping-restart-and-recovery.adoc[Stopping, restart & recovery].
