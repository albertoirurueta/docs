...
since Java 14 the message names the exact expression that was `null` and the operation attempted on it,
which usually pinpoints the bug without a debugger.
