...
:keywords: Java, JDK, JRE, OpenJDK, Adoptium, Temurin, javac, java launcher, bytecode, JVM, write once run anywhere, single-file source launcher, compact source file, instance main, JShell, REPL, IDE, IntelliJ IDEA, Eclipse, VS Code, Apache NetBeans, LTS, release cadence, preview features, enable-preview, Runtime.Version
