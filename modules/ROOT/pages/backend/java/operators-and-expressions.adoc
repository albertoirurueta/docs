...
concatenation (details on xref:backend/java/strings-and-text.adoc[Strings and Text]).
...
xref:backend/java/classes-and-objects.adoc[Classes and Objects] and
xref:backend/java/strings-and-text.adoc[Strings and Text]). `&&` and `||` short-circuit and are what you
...
xref:backend/java/pattern-matching.adoc[Pattern Matching].
...
* xref:backend/java/primitive-types-and-variables.adoc[Primitive Types and Variables] -- the operand
  types, casts, and numeric promotion.
* xref:backend/java/control-flow.adoc[Control Flow] -- `if`, loops, and `switch` expressions built from
  these expressions.
* xref:backend/java/pattern-matching.adoc[Pattern Matching] -- `instanceof` and `switch` type patterns.
* xref:backend/java/strings-and-text.adoc[Strings and Text] -- `==` versus `equals` and `+`
  concatenation.
