= Modules
:description: Explains JavaScript's native ES module syntax -- export, export default, named/default/namespace imports, renaming with as, re-exports, and dynamic import() -- module-level scoping, and how it compares to Node's older CommonJS require()/module.exports system.
:keywords: JavaScript, modules, ES modules, export, import, export default, named exports, dynamic import, import.meta, module scoping, CommonJS, require, module.exports, code splitting
