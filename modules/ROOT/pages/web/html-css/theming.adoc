...
:description: Covers CSS light/dark theming techniques including hex, RGB, and HSL color notations, the HSL color wheel and complementary colors, swapping palette stylesheets, the invert() filter, color-scheme paired with prefers-color-scheme, and the light-dark() function.
:keywords: CSS theming, dark mode, light mode, HSL, hex color, RGB, color-scheme, prefers-color-scheme, light-dark, invert filter, CSS custom properties, color wheel
