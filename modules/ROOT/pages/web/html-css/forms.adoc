...
:description: Covers the core HTML form elements and attributes (form, input, label, textarea, fieldset/legend, select, button), CSS techniques for restyling default form controls, native valid/invalid styling, and file uploads including a custom file-picker control and a drag-and-drop upload zone.
:keywords: HTML forms, form element, text input, checkbox, radio button, label, textarea, fieldset, legend, select element, button, custom select styling, valid invalid pseudo-classes, file input, multipart form data, custom file upload, drag and drop upload, Drag and Drop API
