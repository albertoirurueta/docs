...
content doesn't leave ragged card heights. For cards that should scroll horizontally as a single strip instead
of wrapping into a grid, use `.card-group` (equal-height, edges touching) instead.
